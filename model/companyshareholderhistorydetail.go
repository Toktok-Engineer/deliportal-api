...
type CompanyShareholderHistoryDetail struct {
	ID                          uint    `json:"company_shareholder_history_detail_id"`
	CompanyShareholderHistoryID uint    `gorm:"type:bigint;foreign_key;not null;index:" json:"company_shareholder_history_id"`
...
type SelectCompanyShareholderHistoryDetail struct {
	ID                          uint    `json:"company_shareholder_history_detail_id"`
	CompanyShareholderHistoryID uint    `gorm:"type:bigint;foreign_key;not null;index:" json:"company_shareholder_history_id"`
	ShareholderName             string  `gorm:"type:varchar(100);not null" json:"shareholder_name"`
	NumberOfShare               float64 `gorm:"type:double precision;not null" json:"number_of_share"`
...
type CreateCompanyShareholderHistoryDetailParameter struct {
	CompanyShareholderHistoryID uint    `gorm:"type:bigint;foreign_key;not null;index:" json:"company_shareholder_history_id"`
	ShareholderName             string  `gorm:"type:varchar(100);not null" json:"shareholder_name"`
	NumberOfShare               float64 `gorm:"type:double precision;not null" json:"number_of_share"`
	PercentageOfShare           float64 `gorm:"type:double precision;not null" json:"percentage_of_share"`
