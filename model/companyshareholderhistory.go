...
type CompanyShareholderHistory struct {
	ID            uint    `json:"company_shareholder_history_id"`
...
type SelectCompanyShareholderHistoryParameter struct {
	ID                uint   `json:"company_shareholder_history_id"`
	CompanyID         uint   `gorm:"type:bigint;foreign_key;not null;index:" json:"company_id"`
...
type CreateCompanyShareholderHistoryParameter struct {
	CompanyID     uint    `gorm:"type:bigint;foreign_key;not null;index:" json:"company_id"`
	CompanyAkteId uint    `gorm:"type:bigint;foreign_key;not null;index:" json:"company_akte_id"`
	Remark        string  `gorm:"type:varchar(200)" json:"remark"`
	CreatedUserID uint    `gorm:"type:bigint;not null" json:"created_user_id"`
