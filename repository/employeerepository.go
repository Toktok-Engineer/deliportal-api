...
func (db *EmployeeConnection) CountEmployeeAll() (count int64, err error) {
	res := db.connection.Table("employees").Where("deleted_at = 0").Count(&count)
