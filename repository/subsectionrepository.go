...
func (db *SubSectionConnection) CountSubSectionAll() (count int64, err error) {
	res := db.connection.Debug().Table("sub_sections").Where("deleted_at = 0").Count(&count)
