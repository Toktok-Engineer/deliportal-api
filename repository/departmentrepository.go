...
func (db *DepartmentConnection) CountDepartmentAll() (count int64, err error) {
	res := db.connection.Table("departments").Where("deleted_at = 0").Count(&count)
